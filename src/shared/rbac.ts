...
export const RBAC_PERMISSIONS = {
  ...
  fleetWrite: ['Администратор', 'Руководитель', 'Техник'] as OperatorRole[],
  fleetPhotoWrite: ['Администратор', 'Техник'] as OperatorRole[],
  ...
  sectorManage: ['Администратор', 'Руководитель'] as OperatorRole[],
  sectorExport: ['Администратор', 'Руководитель', 'Оператор'] as OperatorRole[],
  manualWeather: ['Администратор', 'Руководитель', 'Оператор'] as OperatorRole[],
  forceWeatherSync: ['Администратор', 'Руководитель', 'Оператор'] as OperatorRole[],
  listOperators: ['Администратор', 'Руководитель'] as OperatorRole[],
  syncAdmin: ['Администратор'] as OperatorRole[],
  auditRead: ['Администратор', 'Руководитель'] as OperatorRole[],
  ...
  fleetRead: ['Администратор', 'Руководитель', 'Техник', 'Оператор'] as OperatorRole[],
